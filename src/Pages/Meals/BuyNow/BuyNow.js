                ...
                <div className="col-lg-6">
                    ...
                    <div className="d-flex justify-content-center align-items-center">
                        <Form  onSubmit={handleForm} className="w-50">
                            <Form.Control type="text"  readOnly className="text-muted p-2  text-center" value={`Name: ${user.displayName}`  || ''} /> <br />
                            <Form.Control type="text" readOnly className="text-muted p-2  text-center" value={`Email: ${user.email}` || ''} /> <br />
                            <Form.Control type="text" readOnly className="text-muted p-2  text-center" value={`Meal Name: ${meal.name}` || ''} /> <br />
